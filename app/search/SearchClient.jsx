    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px" }}>
      <div style={{ maxWidth: 640, margin: "0 auto 56px" }}>
        <h1 style={{ fontSize: "clamp(32px, 5vw, 56px)", marginBottom: 28, textAlign: "center" }}>
          Search <span style={{ color: "var(--gold)" }}>everything</span>
        </h1>
        <div style={{ position: "relative" }}>
          <input
            ...
            style={{ width: "100%", padding: "16px 52px 16px 20px", fontSize: 16, background: "var(--off-white)", border: "1px solid var(--border2)", borderRadius: "var(--radius-lg)", color: "var(--black)" }}
          />
          <div style={{ position: "absolute", right: 16, top: "50%", transform: "translateY(-50%)", color: "var(--gray)", fontSize: 18, pointerEvents: "none" }}>
            {loading ? "⟳" : "⌕"}
          </div>
        </div>
      </div>

      {loading && <div style={{ textAlign: "center", color: "var(--gray)", padding: "40px 0" }}><div style={{ fontSize: 14 }}>Searching across all stores...</div></div>}
